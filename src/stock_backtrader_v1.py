...
if __name__ == '__main__':
    ...
    # Add a strategy
    cerebro.addstrategy(strategy_004)

    # Create generic CSV datafeed
    datalist = [
        ('data/processed_features/preprocessed_features_2.csv', 'HSI'),
    ]

    data = GenericCSV(dataname=datalist[0][0])
    
    # Get a pandas dataframe
    # modpath = os.path.dirname(os.path.abspath(sys.argv[0]))
    # datapath = os.path.join(modpath, 'data/preprocessed_features_2.csv')
